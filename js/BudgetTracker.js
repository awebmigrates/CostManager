export default class BudgetTracker {
    constructor(querySelectorString) {
        ...
        this.root.querySelector(".download-excel").addEventListener("click", () => {
            this.downloadExcel();
        });
    ...
    static html() {
        return `
            ...
            <button type="button" class="download-excel">Download Excel</button>
        `;
    }
    ...
    downloadExcel() {
        const entries = this.getEntryRows().map(row => {
            return {
                date: row.querySelector(".input-date").value,
                description: row.querySelector(".input-description").value,
                type: row.querySelector(".input-type").value,
